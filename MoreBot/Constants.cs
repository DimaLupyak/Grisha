...
namespace MoreBot
{
    ...
    public static class Constants
    {
        ...
        public static List<Phrase> Phrases = new List<Phrase>()
        {
            ...
            new Phrase {UserId = User.Max,   Text = @"ЕШКАРЕ!"},
            ...
            new Phrase {UserId = User.Mayska, Text = @"це тобі не зуби ломати)"},
            new Phrase {UserId = User.Dimmasya, Text = @"понаїжало тут з Мукачево всяких"},
            new Phrase {UserId = User.Any, Text = @"Оце ти зря так"},
            new Phrase {UserId = User.Any, Text = @"01110100 01101001 00100000 01110000 01101001 01100100 01100001 01110010"},
            ...
            new Phrase {UserId = User.Any, Text = @"це пічально"},
            new Phrase {UserId = User.Any, Text = @"В моё время тебя бы за это повесили"},
            new Phrase {UserId = User.Any, Text = @"Не нервничай"},
            new Phrase {UserId = User.Any, Text = @"кайф"},
            new Phrase {UserId = User.Any, Text = @"это фиаско, братан!"},
            ...
            new Phrase {UserId = User.Toha, Text = @"чувак, поясни за тунелі"},
